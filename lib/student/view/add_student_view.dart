...
class AddStudentView extends StatefulWidget {
  final Function(String id, Map<String, dynamic> studentInfoMap) onAddStudent;
  const AddStudentView({super.key, required this.onAddStudent});
...
class _AddStudentViewState extends State<AddStudentView> {
  ...
  void _onAddButtonPressed() {
    ...
    widget.onAddStudent(id, studentInfoMap);
  }
